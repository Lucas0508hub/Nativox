...
export const translations = {
  en: {
    ...
    exportSuccessDescription: "Folder data has been exported successfully",
    exportError: "Export Failed",
    exportErrorDescription: "Failed to export folder data. Please try again.",
    ...
    // Batch Upload
    dragDropFiles: "Drag audio files here",
    ...
    transcribedSegments: "Transcribed Segments",
    ...
    confirmDeactivateUser: "Are you sure you want to deactivate user \"{userName}\"?",
    ...
    confirmRecalculateAllStats: "Are you sure you want to recalculate statistics for all projects?",
    confirmRecalculateStats: "Are you sure you want to recalculate statistics for this project?",
    confirmDeleteSegment: "Are you sure you want to delete the segment \"{segmentName}\"? This action cannot be undone.",
    ...
    readyForTranslation: "Ready for translation",
    ...
    // Genre
    selectGenre: "Select Segment Genre",
      selectGenreDescription: "Choose the genre that best describes the content of this audio segment. This information is mandatory before saving the transcription.",
      confirmGenre: "Confirm Genre",
    genre: "Genre",
    noGenre: "No genre",
    noGenreDescription: "No specific genre assigned",
    genreUpdated: "Genre updated successfully",
    narrative: "Narrative",
    narrativeDescription: "Stories, tales, reports",
    poetry: "Poetry", 
    poetryDescription: "Verses, poems, poetic literature",
    poetic: "Poetic",
    poeticDescription: "Texts with poetic or lyrical language",
    legalSystem: "Legal System",
    legalSystemDescription: "Laws, regulations, legal documents",
    instruction: "Instruction/Teaching",
    instructionDescription: "Educational, tutorials, explanations",
    letters: "Letters",
    lettersDescription: "Correspondence, personal letters",
    judgment: "Judgment",
    judgmentDescription: "Judicial processes, court decisions",
    parables: "Parables",
    parablesDescription: "Moral stories, fables, parables",
    others: "Others",
    othersDescription: "Other types of content",
    ...
    progressThroughSegments: "Progress through segments",
    segmentSelector: "Segment",
    swipeHint: "Swipe left/right or use arrow keys",
  ...
  pt: {
    ...
    supportedFormats: "Formatos suportados: WAV, MP3, M4A",
    ...
    exportSuccessDescription: "Os dados da pasta foram exportados com sucesso",
    exportError: "Falha na Exportação",
    exportErrorDescription: "Falha ao exportar dados da pasta. Tente novamente.",
    ...
    // Batch Upload
    dragDropFiles: "Arraste arquivos de áudio aqui",
    ...
    confirmResetPassword: "Tem certeza que deseja redefinir a senha deste usuário?",
    ...
    transcribedSegments: "Segmentos Transcritos",
    translatedSegments: "Segmentos Traduzidos",
    ...
    editUserDescription: "Editar informações e permissões do usuário",
    createUserDescription: "Criar uma nova conta de usuário",
    update: "Atualizar",
    create: "Criar",
    confirmDeleteUser: "Tem certeza que deseja deletar o usuário \"{userName}\"? Esta ação não pode ser desfeita.",
    confirmDeactivateUser: "Tem certeza que deseja desativar o usuário \"{userName}\"?",
    ...
    confirmRecalculateAllStats: "Tem certeza que deseja recalcular as estatísticas de todos os projetos?",
    confirmRecalculateStats: "Tem certeza que deseja recalcular as estatísticas deste projeto?",
    confirmDeleteSegment: "Tem certeza que deseja deletar o segmento \"{segmentName}\"? Esta ação não pode ser desfeita.",
    ...
    readyForTranslation: "Pronto para tradução",
    ...
    // Genre
    selectGenre: "Selecionar Gênero do Segmento",
      selectGenreDescription: "Escolha o gênero que melhor descreve o conteúdo deste segmento de áudio. Esta informação é obrigatória antes de salvar a transcrição.",
      confirmGenre: "Confirmar Gênero",
    genre: "Gênero",
    noGenre: "Sem gênero",
    noGenreDescription: "Nenhum gênero específico atribuído",
    genreUpdated: "Gênero atualizado com sucesso",
    narrative: "Narrativo",
    narrativeDescription: "Histórias, contos, relatos",
    poetry: "Poesia",
    poetryDescription: "Versos, poemas, literatura poética",
    poetic: "Poético",
    poeticDescription: "Textos com linguagem poética ou lírica",
    legalSystem: "Sistema Legal",
    legalSystemDescription: "Leis, regulamentos, documentos legais",
    instruction: "Instrução/Ensino",
    instructionDescription: "Educacional, tutoriais, explicações",
    letters: "Cartas",
    lettersDescription: "Correspondências, cartas pessoais",
    judgment: "Julgamento",
    judgmentDescription: "Processos judiciais, decisões de tribunal",
    parables: "Parábolas",
    parablesDescription: "Histórias morais, fábulas, parábolas",
    others: "Outros",
    othersDescription: "Outros tipos de conteúdo",
    ...
    progressThroughSegments: "Progresso pelos segmentos",
    segmentSelector: "Segmento",
    swipeHint: "Deslize para esquerda/direita ou use as setas",
  ...
  es: {
    ...
    exportSuccessDescription: "Los datos de la carpeta se han exportado exitosamente",
    exportError: "Error en la Exportación",
    exportErrorDescription: "Error al exportar datos de la carpeta. Inténtalo de nuevo.",
    ...
    // Batch Upload
    dragDropFiles: "Arrastra archivos de audio aquí",
    ...
    transcribedSegments: "Segmentos Transcritos",
    translatedSegments: "Segmentos Traducidos",
    ...
    editUserDescription: "Editar información y permisos del usuario",
    createUserDescription: "Crear una nueva cuenta de usuario",
    update: "Actualizar",
    create: "Crear",
    confirmDeleteUser: "¿Estás seguro de que quieres eliminar el usuario \"{userName}\"? Esta acción no se puede deshacer.",
    confirmDeactivateUser: "¿Estás seguro de que quieres desactivar el usuario \"{userName}\"?",
    assignedLanguages: "Idiomas Asignados",
    ...
    confirmRecalculateAllStats: "¿Estás seguro de que quieres recalcular las estadísticas de todos los proyectos?",
    confirmRecalculateStats: "¿Estás seguro de que quieres recalcular las estadísticas de este proyecto?",
    confirmDeleteSegment: "¿Estás seguro de que quieres eliminar el segmento \"{segmentName}\"? Esta acción no se puede deshacer.",
    ...
    readyForTranslation: "Listo para traducción",
    ...
    // Genre
    selectGenre: "Seleccionar Género del Segmento",
      selectGenreDescription: "Elija el género que mejor describe el contenido de este segmento de audio. Esta información es obligatoria antes de guardar la transcripción.",
      confirmGenre: "Confirmar Género",
    genre: "Género",
    noGenre: "Sin género",
    noGenreDescription: "Ningún género específico asignado",
    genreUpdated: "Género actualizado exitosamente",
    narrative: "Narrativo",
    narrativeDescription: "Historias, cuentos, relatos",
    poetry: "Poesía",
    poetryDescription: "Versos, poemas, literatura poética",
    poetic: "Poético",
    poeticDescription: "Textos con lenguaje poético o lírico",
    legalSystem: "Sistema Legal",
    legalSystemDescription: "Leyes, regulaciones, documentos legales",
    instruction: "Instrucción/Enseñanza",
    instructionDescription: "Educacional, tutoriales, explicaciones",
    letters: "Cartas",
    lettersDescription: "Correspondencias, cartas personales",
    judgment: "Juicio",
    judgmentDescription: "Procesos judiciales, decisiones de tribunal",
    parables: "Parábolas",
    parablesDescription: "Historias morales, fábulas, parábolas",
    others: "Otros",
    othersDescription: "Otros tipos de contenido",
    ...
    progressThroughSegments: "Progreso a través de segmentos",
    segmentSelector: "Segmento",
    swipeHint: "Desliza izquierda/derecha o usa las flechas",
